# Contributing to livekit-turn-detector-engram

Thank you for considering a contribution—your help keeps this repository healthy for every bobrapet Story.

This guide explains how we work in the `livekit-turn-detector-engram` repository, from filing issues to sending patches.

## How Can I Contribute?

### Reporting Bugs

- Search for an existing report under [Issues](https://github.com/bubustack/livekit-turn-detector-engram/issues).
- If nothing matches, [open a new issue](https://github.com/bubustack/livekit-turn-detector-engram/issues/new) with a clear description, reproduction steps, and both observed and expected behaviour.
...
- Run the quality gates locally:
  - `make lint`
  - `make test`
  - `make docker-build IMG=ghcr.io/<your-user>/livekit-turn-detector-engram:dev` when binaries or Dockerfile paths change
...
2.  Clone your fork: `git clone https://github.com/<your-user>/livekit-turn-detector-engram.git`
3.  Enter the repo: `cd livekit-turn-detector-engram`
